...
#define EP0_OUT     ((INT8U)0x00)  
#define EP0_IN      ((INT8U)0x80) 
#define EP1_OUT     ((INT8U)0x01)  
#define EP1_IN      ((INT8U)0x81)  
#define EP2_OUT     ((INT8U)0x02)  
#define EP2_IN      ((INT8U)0x82)  
#define EP3_OUT     ((INT8U)0x03)  
#define EP3_IN      ((INT8U)0x83) 
#define EP4_OUT     ((INT8U)0x04)  
#define EP4_IN      ((INT8U)0x84)
#define EP5_OUT     ((INT8U)0x05)  
#define EP5_IN      ((INT8U)0x85)
#define EP6_OUT     ((INT8U)0x06)  
#define EP6_IN      ((INT8U)0x86)
#define EP7_OUT     ((INT8U)0x07)  
#define EP7_IN      ((INT8U)0x87)

/* endpoints enumeration */
#define ENDP0       ((INT8U)0)
#define ENDP1       ((INT8U)1)
#define ENDP2       ((INT8U)2)
#define ENDP3       ((INT8U)3)
#define ENDP4       ((INT8U)4)
#define ENDP5       ((INT8U)5)
#define ENDP6       ((INT8U)6)
#define ENDP7       ((INT8U)7)
...
/* Exported macro ------------------------------------------------------------*/
/* SetCNTR */
#define _SetCNTR(wRegValue)  (*CNTR   = (INT16U)wRegValue)

/* SetISTR */
#define _SetISTR(wRegValue)  (*ISTR   = (INT16U)wRegValue)

/* SetDADDR */
#define _SetDADDR(wRegValue) (*DADDR  = (INT16U)wRegValue)

/* SetBTABLE */
#define _SetBTABLE(wRegValue)(*BTABLE = (INT16U)(wRegValue & 0xFFF8))

/* GetCNTR */
#define _GetCNTR()   ((INT16U) *CNTR)

/* GetISTR */
#define _GetISTR()   ((INT16U) *ISTR)

/* GetFNR */
#define _GetFNR()    ((INT16U) *FNR)

/* GetDADDR */
#define _GetDADDR()  ((INT16U) *DADDR)

/* GetBTABLE */
#define _GetBTABLE() ((INT16U) *BTABLE)
...
/* GetENDPOINT */
#define _GetENDPOINT(bEpNum)        ((INT16U)(*(EP0REG + bEpNum)))
...
* Return         : status .
*******************************************************************************/
#define _GetEPTxStatus(bEpNum) ((INT16U)_GetENDPOINT(bEpNum) & EPTX_STAT)

#define _GetEPRxStatus(bEpNum) ((INT16U)_GetENDPOINT(bEpNum) & EPRX_STAT)
...
* Return         : None.
*******************************************************************************/
#define _GetEPAddress(bEpNum) ((INT8U)(_GetENDPOINT(bEpNum) & EPADDR_FIELD))

#define _pEPTxAddr(bEpNum) ((INT32U *)((_GetBTABLE()+bEpNum*8  )*2 + PMAAddr))
#define _pEPTxCount(bEpNum) ((INT32U *)((_GetBTABLE()+bEpNum*8+2)*2 + PMAAddr))
#define _pEPRxAddr(bEpNum) ((INT32U *)((_GetBTABLE()+bEpNum*8+4)*2 + PMAAddr))
#define _pEPRxCount(bEpNum) ((INT32U *)((_GetBTABLE()+bEpNum*8+6)*2 + PMAAddr))
...
*******************************************************************************/
#define _GetEPTxAddr(bEpNum) ((INT16U)*_pEPTxAddr(bEpNum))
#define _GetEPRxAddr(bEpNum) ((INT16U)*_pEPRxAddr(bEpNum))
...
#define _BlocksOf32(dwReg,wCount,wNBlocks) {\
    ...
    if((wCount & 0x1f) == 0)\
      wNBlocks--;\
    *pdwReg = (INT32U)((wNBlocks << 10) | 0x8000);\
  }/* _BlocksOf32 */
...
#define _SetEPRxDblBuf0Count(bEpNum,wCount) {\
    INT32U *pdwReg = _pEPTxCount(bEpNum); \
...
#define _SetEPRxCount(bEpNum,wCount) {\
    INT32U *pdwReg = _pEPRxCount(bEpNum); \
    _SetEPCountRxReg(pdwReg, wCount);\
  }
/*******************************************************************************
...
*******************************************************************************/
#define _GetEPTxCount(bEpNum)((INT16U)(*_pEPTxCount(bEpNum)) & 0x3ff)
#define _GetEPRxCount(bEpNum)((INT16U)(*_pEPRxCount(bEpNum)) & 0x3ff)
...
#define _SetEPDblBuf0Count(bEpNum, bDir, wCount)  { \
    ...
    {_SetEPRxDblBuf0Count(bEpNum,wCount);} \
      ...
      /* IN endpoint */ \
      *_pEPTxCount(bEpNum) = (INT32U)wCount;  \
  } /* SetEPDblBuf0Count*/
...
#define _SetEPDblBuf1Count(bEpNum, bDir, wCount)  { \
    ...
    {_SetEPRxCount(bEpNum,wCount);}\
      ...
      /* IN endpoint */\
      *_pEPRxCount(bEpNum) = (INT32U)wCount; \
  } /* SetEPDblBuf1Count */
...
/* External variables --------------------------------------------------------*/
extern INT16U wIstr;  /* ISTR register last read value */
...
void FreeUserBuffer(INT8U bEpNum/*bEpNum*/, INT8U bDir);
INT16U ToWord(INT8U, INT8U);
INT16U ByteSwap(INT16U);
