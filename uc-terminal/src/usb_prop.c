...
{
    (INT8U*)Virtual_Com_Port_DeviceDescriptor,
    VIRTUAL_COM_PORT_SIZ_DEVICE_DESC
};

ONE_DESCRIPTOR Config_Descriptor =
{
    (INT8U*)Virtual_Com_Port_ConfigDescriptor,
    VIRTUAL_COM_PORT_SIZ_CONFIG_DESC
};

ONE_DESCRIPTOR String_Descriptor[4] =
{
	{(INT8U*)Virtual_Com_Port_StringLangID, VIRTUAL_COM_PORT_SIZ_STRING_LANGID},
	{(INT8U*)Virtual_Com_Port_StringVendor, VIRTUAL_COM_PORT_SIZ_STRING_VENDOR},
	{(INT8U*)Virtual_Com_Port_StringProduct, VIRTUAL_COM_PORT_SIZ_STRING_PRODUCT},
	{(INT8U*)Virtual_Com_Port_StringSerial, VIRTUAL_COM_PORT_SIZ_STRING_SERIAL}
};
...
*********************************************************************************************************
*/
RESULT Virtual_Com_Port_Data_Setup(INT8U RequestNo)
{
...
*********************************************************************************************************
*/
RESULT Virtual_Com_Port_NoData_Setup(INT8U RequestNo)
{
	if (Type_Recipient == (CLASS_REQUEST | INTERFACE_RECIPIENT))
	{
...
*********************************************************************************************************
*/
INT8U *Virtual_Com_Port_GetDeviceDescriptor(INT16U Length)
{
...
*********************************************************************************************************
*/
INT8U *Virtual_Com_Port_GetConfigDescriptor(INT16U Length)
{
...
*********************************************************************************************************
*/
INT8U *Virtual_Com_Port_GetStringDescriptor(INT16U Length)
{
	INT8U wValue0 = pInformation->USBwValue0;
	if (wValue0 > 4)
	{
		return NULL;
	}
