...
** Last Version:		V1.0
** Descriptions:		SD/MMC 卡读写模块: 相关工具函数 ---- CRC校验
...
/*******************************************************************************************************************
** Name:	  INT8U SD_GetCmdByte6()
** Function:      get the CRC7 of the command of SD card
** Input:         INT8U cmd   :	command
**    	          INT8U *param: the param of command,length is 4 bytes
** Output:	  CRC7 code
********************************************************************************************************************/
