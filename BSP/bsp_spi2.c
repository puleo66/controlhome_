...
/*******************************************************************************************************************
** Name:	  void SPI2_ClkToMax()
** Function: set the clock of SPI to maximum
** Input:	  NULL
** Output:	  NULL
********************************************************************************************************************/
void SPI2_ClkToMax(void)
{
	SPI_InitTypeDef   SPI_InitStructure;
...
/*******************************************************************************************************************
** Name:	  void MSD_CS_Assert()
** Function: select the SPI MMC slave 
** Input:	  NULL
** Output:	  NULL
********************************************************************************************************************/
void MSD_CS_Assert(void)
{
        while (SPI2_ASSERT_FLAGH);
	MSD_CS_LOW();			   					/* select the SPI slave */ 
        SPI2_ASSERT_FLAGH = TRUE;
}


/*******************************************************************************************************************
** Name:	  void MSD_CS_Deassert()
** Function: not select the SPI MMC slave 
** Input:	  NULL
** Output:	  NULL
********************************************************************************************************************/
void MSD_CS_Deassert(void)
{
	MSD_CS_HIGH();			    		         		/* not select the SPI slave */
        SPI2_ASSERT_FLAGH = FALSE;
}
...
/*******************************************************************************************************************
** Name:	  void SPI2_HardWareInit()
** Function: initialize the hardware condiction that access sd card, and rf device
** Input:	  NULL
** Output:	  NULL
********************************************************************************************************************/
void SPI2_HardWareInit(void)
{ 
	SPI2_Config();								
